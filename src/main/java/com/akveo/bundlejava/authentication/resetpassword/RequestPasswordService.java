...
import com.akveo.bundlejava.service.email.EmailServiceImpl;
import com.akveo.bundlejava.service.email.Mail;
...
public class RequestPasswordService {
    ...
    public void requestPassword(RequestPasswordDTO requestPasswordDTO) throws IncorrectEmailHttpException, CantSendEmailHttpException  {
        User user;
        ...
        try {
            ...
            emailRequest.setFrom(new InternetAddress("contact.cmedicolegal@gmail.com"));
    ...
    private LocalDateTime calculateExpirationDate(long tokenExpirationDuration) {
        return LocalDateTime.now().plusMinutes(tokenExpirationDuration);
    }
    ...
    private String createResetUrl(RestorePassword restorePassword) throws JsonProcessingException {
        ...
        restorePasswordTokenDto.setExpiresIn(restorePassword.getExpiresIn());
        restorePasswordTokenDto.setToken(restorePassword.getToken());
        restorePasswordTokenDto.setId(restorePassword.getId());
